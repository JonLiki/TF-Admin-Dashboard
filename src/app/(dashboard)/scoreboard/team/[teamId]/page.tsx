                            ...
                            <div key={m.id} className="p-4 hover:bg-white/5 transition-colors">
                                ...
                                <div className="grid grid-cols-3 gap-2 text-center">
                                    <div className="bg-white/5 rounded-lg p-2 border border-white/10">
                                        <p className="text-micro uppercase text-offwhite/60 font-bold tracking-widest">KM</p>
                                        <p className="font-mono font-bold text-lagoon-100">{m.stats.totalKm.toFixed(2)}</p>
                                    </div>
                                    <div className="bg-white/5 rounded-lg p-2 border border-white/10">
                                        <p className="text-micro uppercase text-offwhite/60 font-bold tracking-widest">Lifestyle</p>
                                        <p className="font-mono font-bold text-green-400">{m.stats.lifestylePoints}</p>
                                    </div>
                                    <div className="bg-white/5 rounded-lg p-2 border border-white/10">
                                        <p className="text-micro uppercase text-offwhite/60 font-bold tracking-widest">Loss</p>
